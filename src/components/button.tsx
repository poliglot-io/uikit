...
import { isSparqlTrigger, useTrigger, type SparqlTrigger } from "./action";
...
type ButtonProps = Omit<React.ComponentProps<"button">, "onClick"> &
  VariantProps<typeof buttonVariants> & {
    ...
    onClick?: React.ComponentProps<"button">["onClick"] | SparqlTrigger;
  };
...
function Button({
  ...
  const handleClick: React.ComponentProps<"button">["onClick"] =
    isSparqlTrigger(onClick)
      ? () => {
